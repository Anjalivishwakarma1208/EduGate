    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="{{ route('semester.index') }}">Courses</a></li>
  ...
  <div class="card">
    ...
    <div class="card-body">
        <div class="mb-3">
            ...
            <input value="{{ old('semester_number') }}" type="text" class="form-control form-control-lg @error('semester_number') is-invalid @enderror" placeholder="Enter Semester Number" name="semester_number" id="semester_number">
